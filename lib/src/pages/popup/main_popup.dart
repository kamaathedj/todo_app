...
class Pop extends StatelessWidget {
  final GlobalKey<ScaffoldState> createScafoldState;
  Pop(this.createScafoldState);
        ...
        showMenu(
          ...
          items: <PopupMenuEntry>[
             PopupMenuItem(
               child: Row(
                 children: <Widget>[
                   Icon(GroovinMaterialIcons.settings),
                   FlatButton(
                     child: Text('Setttings',style: TextStyle(color: Theme.of(context).textSelectionColor)),
                     onPressed: (){
                       Navigator.pop(context);
                      controller=this.createScafoldState.currentState.showBottomSheet(
                         (context)=>BottomSheet(
                           elevation: 50,
                           enableDrag: true,
             ...
             PopupMenuItem(
                ...
                child:Row(children: <Widget>[
                  Icon(GroovinMaterialIcons.information),
                  SizedBox(width: 10,),
                  Text('About todo app')
                ],)
